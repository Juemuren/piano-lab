...
このシミュレーターには、次のツールがあります。

- [倍音シンセサイザー](#倍音シンセサイザー): 音の合成を調整
- [音色調整](#音色調整): 音色を完全にカスタマイズ
- [伝達関数エディター](#伝達関数エディター): 伝達関数を変更
- [楽譜エディター](#楽譜エディター): テキストで楽譜を書き、自動演奏

モバイル表示とダークモードにも対応しています。

### 倍音シンセサイザー

- サンプリングではなく、物理モデルに基づいて音を合成
- 十二平均律で音階を生成し、自由な移調に対応
- 10 個の倍音を使い、豊かで十分にリアルな音色を生成
- ADSR エンベロープを使い、複数のパラメーターを調整可能

### 音色調整

音色調整では音色を完全にカスタマイズできます。また、複数のプリセットも用意されています。
...
伝達関数エディターは、音の伝搬過程における振幅特性と位相特性をシミュレートします。伝達関数は周波数に対して連続的で、完全なカスタマイズには向かないため、プリセットと調整可能なパラメーターを提供しています。
...
- 楽譜上の音符をクリックするとその音を再生し、選択した音符から演奏を開始可能
- テンポ、拍子、調号を変更でき、和音、反復、複数声部にも対応
- 難易度の異なる複数のプリセット楽譜を収録
